                  ...
                  children: [
                    SizedBox(height: 200, child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Row(
                            children: [
                              Container(height: 320,width: 200, margin: EdgeInsets.fromLTRB(0, 10, 40, 5),
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
                                  color: Colors.grey.shade300 ),
                               child:
                               TodayWidget(
                                  imageName: Image.asset("images/french_toast_large.png", height: 80,width: 150,),
                          headerText: "Breakfast",
                          titleText: "French Toast with Berries", caloriesText: "120 Calories",
                          timeText: "10 mins", servingText: "1 Serving"),
                              ),
                              Container(height: 320,width: 220, margin: EdgeInsets.fromLTRB(0, 10, 40, 5),
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
                                    color: Colors.grey.shade300 ),
                                child: TodayWidget(
                                    imageName: Image.asset("images/cinnamon_large.png",height: 80,width: 150,),
                                    headerText: "Breakfast",
                    ...
                    ListView.separated(
                      ...
                      return Column(
                        children: [
                          RecommendedWidget(imageName: Image.asset("images/muffins_large2.png",height: 180,width: 100,),
                            headerText: "Breakfast",
                            titleText: "Blueberry Muffins", caloriesText: "120 Calories",
                            timeText: "10 mins", servingText: "1 Serving"),
                          SizedBox(height: 10,),
                          RecommendedWidget(imageName: Image.asset("images/glazed_large.png",height: 180,width: 100,),
